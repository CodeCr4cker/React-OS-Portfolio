import{m as It,F as om,L as am,y as ie,o as Zo,p as Fl,n as cs,I as um,g as cm,d as Ol,J as lm,h as hm,K as dm,M as fm,u as si,N as Ll,O as ql,e as mm,f as gm,G as pm,r as cc,S as _m}from"./index.esm-DFBNkFO4.js";var lc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ce=new am("@firebase/firestore");function xn(){return Ce.logLevel}function Ey(r){Ce.setLogLevel(r)}function x(r,...t){if(Ce.logLevel<=ie.DEBUG){const e=t.map(ta);Ce.debug(`Firestore (${sr}): ${r}`,...e)}}function mt(r,...t){if(Ce.logLevel<=ie.ERROR){const e=t.map(ta);Ce.error(`Firestore (${sr}): ${r}`,...e)}}function zt(r,...t){if(Ce.logLevel<=ie.WARN){const e=t.map(ta);Ce.warn(`Firestore (${sr}): ${r}`,...e)}}function ta(r){if(typeof r=="string")return r;try{return function(e){return JSON.stringify(e)}(r)}catch{return r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ws(r,t){return[r,xt(t)]}function rh(r,t,e){return[r,xt(t),e]}const Lm={},jn="documentMutations",oi="remoteDocumentsV14",qm=["prefixPath","collectionGroup","readTime","documentId"],Hs="documentKeyIndex",Bm=["prefixPath","collectionGroup","documentId"],sh="collectionGroupIndex",Um=["collectionGroup","readTime","prefixPath","documentId"],Xr="remoteDocumentGlobal",xo="remoteDocumentGlobalKey",Gn="targets",ih="queryTargetsIndex",jm=["canonicalId","targetId"],zn="targetDocuments",Gm=["targetId","path"],ia="documentTargetsIndex",zm=["path","targetId"],ai="targetGlobalKey",sn="targetGlobal",Zr="collectionParents",Km=["collectionId","parent"],Kn="clientMetadata",$m="clientId",wi="bundles",Qm="bundleId",Ai="namedQueries",Wm="name",oa="indexConfiguration",Hm="indexId",Do="collectionGroupIndex",Jm="collectionGroup",Gr="indexState",Ym=["indexId","uid"],oh="sequenceNumberIndex",Xm=["uid","sequenceNumber"],zr="indexEntries",Zm=["indexId","uid","arrayValue","directionalValue","orderedDocumentKey","documentKey"],ah="documentKeyIndex",tg=["indexId","uid","orderedDocumentKey"],vi="documentOverlays",eg=["userId","collectionPath","documentId"],No="collectionPathOverlayIndex",ng=["userId","collectionPath","largestBatchId"],uh="collectionGroupOverlayIndex",rg=["userId","collectionGroup","largestBatchId"],aa="globals",sg="name",ch=[Yr,Qt,jn,Ye,Gn,hs,sn,zn,Kn,Xr,Zr,wi,Ai],ig=[...ch,vi],lh=[Yr,Qt,jn,oi,Gn,hs,sn,zn,Kn,Xr,Zr,wi,Ai,vi],hh=lh,ua=[...hh,oa,Gr,zr],og=ua,dh=[...ua,aa],ag=dh;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vi{constructor(){this._=void 0}}function Cg(r,t,e){return r instanceof Hn?function(s,i){const a={fields:{[_h]:{stringValue:ph},[Ih]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Ri(i)&&(i=Pi(i)),i&&(a.fields[yh]=i),{mapValue:a}}(e,t):r instanceof ln?Gh(r,t):r instanceof hn?zh(r,t):function(s,i){const a=jh(s,i),u=Dc(a)+Dc(s.Ae);return Fo(a)&&Fo(s.Ae)?Bh(u):ma(s.serializer,u)}(r,t)}function xg(r,t,e){return r instanceof ln?Gh(r,t):r instanceof hn?zh(r,t):e}function jh(r,t){return r instanceof Jn?function(n){return Fo(n)||function(i){return!!i&&"doubleValue"in i}(n)}(t)?t:{integerValue:0}:null}class Hn extends Vi{}class ln extends Vi{constructor(t){super(),this.elements=t}}function Gh(r,t){const e=Kh(t);for(const n of r.elements)e.some(s=>se(s,n))||e.push(n);return{arrayValue:{values:e}}}class hn extends Vi{constructor(t){super(),this.elements=t}}function zh(r,t){let e=Kh(t);for(const n of r.elements)e=e.filter(s=>!se(s,n));return{arrayValue:{values:e}}}class Jn extends Vi{constructor(t,e){super(),this.serializer=t,this.Ae=e}}function Dc(r){return ut(r.integerValue||r.doubleValue)}function Kh(r){return rs(r)&&r.arrayValue.values?r.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ps{constructor(t,e,n,s,i){this.snapshotVersion=t,this.targetChanges=e,this.targetMismatches=n,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(t,e,n){const s=new Map;return s.set(t,_s.createSynthesizedTargetChangeForCurrentChange(t,e,n)),new ps(B.min(),s,new it(G),Lt(),z())}}class _s{constructor(t,e,n,s,i){this.resumeToken=t,this.current=e,this.addedDocuments=n,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(t,e,n){return new _s(n,e,z(),z(),z())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rd{constructor(t,e,n,s){this.remoteDocumentCache=t,this.mutationQueue=e,this.documentOverlayCache=n,this.indexManager=s}getDocument(t,e){let n=null;return this.documentOverlayCache.getOverlay(t,e).next(s=>(n=s,this.remoteDocumentCache.getEntry(t,e))).next(s=>(n!==null&&Qr(n.mutation,s,Ot.empty(),Z.now()),s))}getDocuments(t,e){return this.remoteDocumentCache.getEntries(t,e).next(n=>this.getLocalViewOfDocuments(t,n,z()).next(()=>n))}getLocalViewOfDocuments(t,e,n=z()){const s=Zt();return this.populateOverlays(t,s,e).next(()=>this.computeViews(t,e,s,n).next(i=>{let a=Lr();return i.forEach((u,c)=>{a=a.insert(u,c.overlayedDocument)}),a}))}getOverlayedDocuments(t,e){const n=Zt();return this.populateOverlays(t,n,e).next(()=>this.computeViews(t,e,n,z()))}populateOverlays(t,e,n){const s=[];return n.forEach(i=>{e.has(i)||s.push(i)}),this.documentOverlayCache.getOverlays(t,s).next(i=>{i.forEach((a,u)=>{e.set(a,u)})})}computeViews(t,e,n,s){let i=Lt();const a=$r(),u=function(){return $r()}();return e.forEach((c,h)=>{const f=n.get(h.key);s.has(h.key)&&(f===void 0||f.mutation instanceof de)?i=i.insert(h.key,h):f!==void 0?(a.set(h.key,f.mutation.getFieldMask()),Qr(f.mutation,h,f.mutation.getFieldMask(),Z.now())):a.set(h.key,Ot.empty())}),this.recalculateAndSaveOverlays(t,i).next(c=>(c.forEach((h,f)=>a.set(h,f)),e.forEach((h,f)=>u.set(h,new gp(f,a.get(h)??null))),u))}recalculateAndSaveOverlays(t,e){const n=$r();let s=new it((a,u)=>a-u),i=z();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,e).next(a=>{for(const u of a)u.keys().forEach(c=>{const h=e.get(c);if(h===null)return;let f=n.get(c)||Ot.empty();f=u.applyToLocalView(h,f),n.set(c,f);const m=(s.get(u.batchId)||z()).add(c);s=s.insert(u.batchId,m)})}).next(()=>{const a=[],u=s.getReverseIterator();for(;u.hasNext();){const c=u.getNext(),h=c.key,f=c.value,m=qh();f.forEach(p=>{if(!i.has(p)){const v=$h(e.get(p),n.get(p));v!==null&&m.set(p,v),i=i.add(p)}}),a.push(this.documentOverlayCache.saveOverlays(t,h,m))}return A.waitFor(a)}).next(()=>n)}recalculateAndSaveOverlaysForDocumentKeys(t,e){return this.remoteDocumentCache.getEntries(t,e).next(n=>this.recalculateAndSaveOverlays(t,n))}getDocumentsMatchingQuery(t,e,n,s){return Eg(e)?this.getDocumentsMatchingDocumentQuery(t,e.path):da(e)?this.getDocumentsMatchingCollectionGroupQuery(t,e,n,s):this.getDocumentsMatchingCollectionQuery(t,e,n,s)}getNextDocuments(t,e,n,s){return this.remoteDocumentCache.getAllFromCollectionGroup(t,e,n,s).next(i=>{const a=s-i.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,e,n.largestBatchId,s-i.size):A.resolve(Zt());let u=qn,c=i;return a.next(h=>A.forEach(h,(f,m)=>(u<m.largestBatchId&&(u=m.largestBatchId),i.get(f)?A.resolve():this.remoteDocumentCache.getEntry(t,f).next(p=>{c=c.insert(f,p)}))).next(()=>this.populateOverlays(t,h,i)).next(()=>this.computeViews(t,c,h,z())).next(f=>({batchId:u,changes:Lh(f)})))})}getDocumentsMatchingDocumentQuery(t,e){return this.getDocument(t,new k(e)).next(n=>{let s=Lr();return n.isFoundDocument()&&(s=s.insert(n.key,n)),s})}getDocumentsMatchingCollectionGroupQuery(t,e,n,s){const i=e.collectionGroup;let a=Lr();return this.indexManager.getCollectionParents(t,i).next(u=>A.forEach(u,c=>{const h=function(m,p){return new le(p,null,m.explicitOrderBy.slice(),m.filters.slice(),m.limit,m.limitType,m.startAt,m.endAt)}(e,c.child(i));return this.getDocumentsMatchingCollectionQuery(t,h,n,s).next(f=>{f.forEach((m,p)=>{a=a.insert(m,p)})})}).next(()=>a))}getDocumentsMatchingCollectionQuery(t,e,n,s){let i;return this.documentOverlayCache.getOverlaysForCollection(t,e.path,n.largestBatchId).next(a=>(i=a,this.remoteDocumentCache.getDocumentsMatchingQuery(t,e,n,i,s))).next(a=>{i.forEach((c,h)=>{const f=h.getKey();a.get(f)===null&&(a=a.insert(f,at.newInvalidDocument(f)))});let u=Lr();return a.forEach((c,h)=>{const f=i.get(c);f!==void 0&&Qr(f.mutation,h,Ot.empty(),Z.now()),ms(e,h)&&(u=u.insert(c,h))}),u})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sa{constructor(t,e,n,s){this.targetId=t,this.fromCache=e,this.Ts=n,this.Es=s}static Is(t,e){let n=z(),s=z();for(const i of e.docChanges)switch(i.type){case 0:n=n.add(i.doc.key);break;case 1:s=s.add(i.doc.key)}return new Sa(t,e.fromCache,n,s)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Uy(){return new Ts("deleteField")}function jy(){return new Ha("serverTimestamp")}function Gy(...r){return new Ja("arrayUnion",r)}function zy(...r){return new Ya("arrayRemove",r)}function Ky(r){return new Xa("increment",r)}function $y(r){return new $t(r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Gt._jsonSchemaVersion="firestore/querySnapshot/1.0",Gt._jsonSchema={type:_t("string",Gt._jsonSchemaVersion),bundleSource:_t("string","QuerySnapshot"),bundleName:_t("string"),bundle:_t("string")};const gy={maxAttempts:5};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
